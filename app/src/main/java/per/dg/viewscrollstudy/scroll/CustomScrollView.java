package per.dg.viewscrollstudy.scroll;
...
public abstract class CustomScrollView extends TextView {
    ...
    public abstract void scrollMethed(int offX, int offY);
}
